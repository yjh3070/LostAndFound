...
<head>
    ...
    <link rel="stylesheet" href="stylesheets/found.css?after">
    <title>found</title>
    ...
    <script type="text/javascript"> 
        const replyDelete = function(id, reply){
            ...
            const path = "found_reply_delete.php";
        ...
        const postDelete = function(id){
            ...
            hiddenField2.setAttribute("value", "found");
...
<body>
    ...
    <section class="board">
        <div class="upload">
            <span>물건을 주웠을 때</span>
            <button type="button" class="btn btn-upload" data-toggle="modal" data-target="#exampleModalCenter">습득했어요!</button>
        </div>
            ...
            <table class="table list">
                <thead>
                    <tr>
                        ...
                        <td scope="col" style="width: 50%;">글 제목</td>
                        <td scope="col" style="width: 12%">작성자</td>
                        <td scope="col" style="width: 14%">보관 상태</td>
                        <td scope="col">날짜</td>
                    </tr>
                </thead>
            </table>
                    ...
                    <nav aria-label="...">
                        <ul class="pagination">
                            <li class="page-item <?php if($page == 1) echo 'disabled'?>">
                                <a class="page-link prev" href="found.php?page=<?=$page-1?>" <?php if($page == 1) echo 'tabindex="-1" aria-disabled="true"'?>>&laquo;</a>
                            </li>
                            <?php
                            ...
                            ?>
                                <li class="page-item active">
                                    <a class="page-link" href="found.php?page=<?=$p?>"><?=$p?></a>
                                </li>
                            <?php
                                } else {
                            ?>
                            ...
                            <li class="page-item <?php if($page == $e_page) echo 'disabled'?>">
                                <a class="page-link next" href="found.php?page=<?=$page+1?>" <?php if($page == $e_page) echo 'tabindex="-1" aria-disabled="true"'?>>&raquo;</a>
                            </li>
                        </ul>
                    </nav>
